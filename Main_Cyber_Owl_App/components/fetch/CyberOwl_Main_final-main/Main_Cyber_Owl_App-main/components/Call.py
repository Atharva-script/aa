...
SAMPLE_FPS = 5.0                # LOWERED to 5 FPS to reduce CPU usage
DETECT_RESIZE = (640, 480)       # INCREASED to 640x480 for better detection accuracy
CONF_THRESHOLD = 0.15            # LOWERED to 15% to increase sensitivity
MIN_BBOX_AREA_FRAC = 0.0005      
COOLDOWN_SECONDS = 5             # REDUCED to 5 seconds for faster alerts
