...
class BackendMonitor {
  ...
  Future<bool> _waitForExternalServer() async {
    ...
    debugPrint('║   Run: start_backend.bat             ║');
    debugPrint('╚═══════════════════════════════════════╝');

    _lastError = 'Could not connect to external server.\n\n'
        '1. Ensure the backend is running (start_backend.bat)\n'
        '2. Check your internet connection if using remote\n'
        '3. Verify the URL in Settings if custom';
