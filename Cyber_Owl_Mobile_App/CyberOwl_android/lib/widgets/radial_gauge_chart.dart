...
class _RadialGaugeChartState extends State<RadialGaugeChart>
  ...
  Widget build(BuildContext context) {
    final surfaceColor = AppColors.getSurface(widget.isDark);
    final textColor = AppColors.getTextPrimary(widget.isDark);
    final secondaryTextColor = AppColors.getTextSecondary(widget.isDark);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: AppColors.getDivider(widget.isDark).withValues(alpha: 0.5),
          width: 1,
        ),
      ),
      child: Column(
...
class _GaugeBackgroundPainter extends CustomPainter {
  ...
  _GaugeBackgroundPainter({required this.isDark});
